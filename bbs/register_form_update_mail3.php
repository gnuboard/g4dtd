    ...
    <td align="center" class="line" >
        ...
        <tr>
            <td>
                ...
                <tr><td height="150">
                    <b><?php echo $mb_name?></b> 님의 E-mail 주소가 변경되었습니다.

                    <p>아래의 주소를 클릭하시면 인증이 완료됩니다.
                    <p><a href='<?php echo $certify_href?>'><b><?php echo $certify_href?></b></a>
                ...
                <tr>
                    <td height="25" bgcolor="#EDEDED" align="center">로그인 후 모든 정보를 이용하실 수 있습니다.[<a href="<?php echo $g4[url]?>/<?php echo $g4[bbs]?>/login.php">바로가기</a>]</td>
                </tr>
                </table>
            </td>
        </tr>
