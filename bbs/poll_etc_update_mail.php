    ...
    <td align="center" class="line" >
        ...
        <tr>
            <td>
                ...
                <tr>
                    <td height="25" bgcolor=#F7F1D8>제목 : <?php echo $subject?></td>
                </tr>
                <tr>
                    <td height="25" bgcolor=#F7F1D8>게시자 : <?php echo $name?> <?php echo $mb_id?></td>
                </tr>
                </table>
                <p>

                <table width="500" border="0" align="center" cellpadding="4" cellspacing="0">
                <tr><td height="150"><?php echo $content?></td></tr>
                </table>
                <p>
            </td>
        </tr>
