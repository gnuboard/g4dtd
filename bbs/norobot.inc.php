...
if ($config['cf_use_norobot']) {
    ...
    for ($i=0; $i<count($arr); $i++)
    {
        ...
        $norobot_str .= "<span style='color:#FF0000;font-weight:bold;'>{$tmp_str[$k]}</span>";
    ...
    $norobot_str = "<span style='color:#999999'>$norobot_str</span>";
...
//<![CDATA[
var md5_norobot_key = '<?php echo md5($norobot_key); ?>';
//]]>
</script>