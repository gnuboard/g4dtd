...
// 기타의견 리스트
$sql = " select a.*, b.mb_open from $g4[poll_etc_table] a left join $g4[member_table] b on (a.mb_id = b.mb_id) where po_id = '$po_id' order by pc_id desc ";
...
if (!preg_match("/[a-z0-9-_]+/i", $skin_dir)) $skin_dir = "basic"; // 해킹방지
