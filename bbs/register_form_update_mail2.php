    ...
    <td align="center" class="line" >
        ...
        <tr>
            <td>
                ...
                <tr><td height="150"><b><?php echo $mb_name?></b> 님께서 회원가입 하셨습니다.
                    <p>회원 아이디 : <b><?php echo $mb_id?></b>
                    <p>회원 이름 : <?php echo $mb_name?>
                    <p>회원 별명 : <?php echo $mb_nick?>
                    <p>추천인아이디 : <?php echo $mb_recommend?></td></tr>
                </table>
                <p>
                ...
                <tr>
                    <td height="25" bgcolor="#EDEDED" align="center">관리자화면에서 자세한 내용을 확인하실 수 있습니다.[<a href="<?php echo $g4[url]?>/<?php echo $g4[admin]?>/member_form.php?w=u&mb_id=<?php echo $mb_id?>">바로가기</a>]</td>
                </tr>
                </table>
            </td>
        </tr>
