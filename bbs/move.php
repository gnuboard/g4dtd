...
<div id="pop_contents">
    ...
    <tr>
        <td><input type='checkbox' id='chk<?php echo $i?>' name='chk_bo_table[]' value="<?php echo $list[$i][bo_table]?>" /></td>
...
<div id="pop_tailer">
    <input type='image' id='btn_submit' src="<?php echo $g4[path]?>/img/btn_newwin_confirm.gif" alt="확인" /></a>
    <a href="javascript:;" onclick="window.close();"><img src="<?php echo $g4[path]?>/img/btn_close.gif" alt="창닫기" /></a>
</div>
</form>
