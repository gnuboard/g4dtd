...
while($row = sql_fetch_array($result))
{
    ...
    echo "<script type='text/javascript'>document.getElementById('ct').innerHTML += '$str';</script>\n";
...
echo "<script type='text/javascript'>document.getElementById('ct').innerHTML += '<br /><br />테이블 복구 및 최적화 완료.<br /><br />프로그램의 실행을 끝마치셔도 좋습니다.';</script>\n";
?>