...
<?//=subtitle_bar($html_title)?><p></p>

<div align='right'>선택된 회원수 : <?php echo number_format($cnt)?> 명</div>
<form name='fmailselectlist' method='post' action='#' onsubmit="return fmailselectlist_submit(this);">
