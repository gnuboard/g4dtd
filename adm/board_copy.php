...
<tr>
    <td colspan=2 class=title align=left><img src='<?php echo $g4[admin_path]?>/img/icon_title.gif'> <?php echo $g4[title]?></td>
</tr>
...
<tr class='ht'>
	<td>게시판 제목</td>
	<td><input type=text class=ed name='target_subject' size=60 maxlength=120 required itemname='게시판 제목' value='[복사본] <?php echo $board[bo_subject]?>'></td>
</tr>
<tr class='ht'>
	<td>복사 유형</td>
	<td>
